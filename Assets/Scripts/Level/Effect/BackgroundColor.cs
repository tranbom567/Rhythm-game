...
public class BackgroundColor : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            PlayerManager.getInstance.bgScript.bg1.GetComponent<Image>().DOColor(inColor, duration).SetEase(easeType);
            PlayerManager.getInstance.bgScript.bg2.GetComponent<Image>().DOColor(inColor, duration).SetEase(easeType);
        }
    }
    void Start()
    {
